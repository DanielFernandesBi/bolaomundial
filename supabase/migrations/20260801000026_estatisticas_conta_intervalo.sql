-- Acrescenta `com_intervalo`: em quantos jogos o placar do INTERVALO é
-- conhecido.
--
-- A tela escondia o bloco de 1º tempo quando ht_pro + ht_contra era zero. Só
-- que 0–0 no intervalo é um placar legítimo, não ausência de dado — o Cruzeiro
-- tem exatamente isso (0–0 no intervalo, 0–1 no fim), e o bloco sumia como se
-- o backfill tivesse falhado. Contar quantos jogos TÊM o dado separa "não
-- fez gol" de "não sabemos".
--
-- O corpo é o de 20260801000025 com a coluna nova; o restante não muda.
