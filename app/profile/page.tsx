...
// Perfil geral
// ============================================================================
// Rearranjo do bloco 6c. O que mudou é só a disposição:
//   · cabeçalho centralizado, avatar de 76px (era 96px em linha, ocupando um
//     terço da tela do celular sem dizer nada de novo);
//   · dois cards-herói — Pontos totais e Dinheiro ganho, este em `text-money`;
//   · as demais métricas viram faixas de números, não sete cards de peso igual;
//   · "Bolões que você jogou" passa de card empilhado a linha por torneio.
//
// Nenhum número foi retirado: todas as métricas que existiam continuam na tela,
// só que hierarquizadas. A escala de cores já havia sido resolvida no 5a.
// ============================================================================
...
export default async function GeneralProfilePage() {
  const { profile, error } = await getGeneralProfile();
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-background">
      <div className="container mx-auto max-w-full px-4 py-8 pb-28 md:pb-8">
        ...
        {/* Herói: pontos e dinheiro. São os dois números que o jogador procura. */}
        <div className="mb-4 grid grid-cols-2 gap-3">
          ...
          <div className="rounded-[16px] border border-border bg-card p-4">
            ...
            <p className="mt-1 text-[26px] font-bold leading-none tabular-nums text-money">
        ...
        <p className={`mb-2 ${legenda}`}>Bolões que você jogou</p>
        ...
        {/* Tema claro/escuro — é por aqui que o desktop alcança o botão, já que
            a navbar não é editada nesta refatoração. */}
